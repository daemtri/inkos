...
const CASES: readonly PromptCase[] = [
  ["chat/free-text proposes only", "zh", "chat", null, undefined, ["普通聊天助手", "propose_action"], ["sub_agent", "short_fiction_run", "play_start：", "play_revise：", "play_step："]],
  ["chat/en/free-text proposes only", "en", "chat", null, undefined, ["general chat assistant", "propose_action"], ["sub_agent", "short_fiction_run", "play_start:", "play_revise:", "play_step:"]],
  ...
  ["short/confirmed-run exposes runner", "zh", "short", null, { actionSource: "button", requestedIntent: "short_run" }, ["short_fiction_run"], ["propose_action", "sub_agent", "play_start"]],
  ...
  ["edit/active deterministic only", "zh", "edit", "demo-book", undefined, ["read", "write_truth_file", "rename_entity", "patch_chapter_text"], ["sub_agent", "short_fiction_run", "play_start", "play_revise", "play_step"]],
];
